...
Route::get('/items/{item}', [ItemController::class, 'show'])->name('items.show')->middleware('profile.completed'); // 商品詳細画面

Route::middleware(['auth', 'profile.completed'])->group(function () {
    Route::post('/items/{item}/comments', [ItemController::class, 'storeComment'])->name('items.comments.store'); // 商品コメント投稿
    ...
    Route::post('/items/{item}/like', [ItemController::class, 'toggleLike'])->name('items.toggle_like'); // 商品いいね、いいね解除処理
