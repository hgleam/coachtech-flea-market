...
初期環境構築時には、以下の10件の商品データが作成されます：

| 商品ID | 商品名 | 価格 | 商品説明 | 画像パス | コンディション |
|--------|--------|------|----------|----------|----------------|
| C001 | 腕時計 | 15,000 | スタイリッシュなデザインのメンズ腕時計 | `images/items/1.jpg` | 良好 |
| C002 | HDD | 5,000 | 高速で信頼性の高いハードディスク | `images/items/2.jpg` | 目立った傷や汚れなし |
| C003 | 玉ねぎ3束 | 300 | 新鮮な玉ねぎ3束のセット | `images/items/3.jpg` | やや傷や汚れあり |
| C004 | 革靴 | 4,000 | クラシックなデザインの革靴 | `images/items/4.jpg` | 状態が悪い |
| C005 | ノートPC | 45,000 | 高性能なノートパソコン | `images/items/5.jpg` | 良好 |
| C006 | マイク | 8,000 | 高音質のレコーディング用マイク | `images/items/6.jpg` | 目立った傷や汚れなし |
| C007 | ショルダーバッグ | 3,500 | おしゃれなショルダーバッグ | `images/items/7.jpg` | やや傷や汚れあり |
| C008 | タンブラー | 500 | 使いやすいタンブラー | `images/items/8.jpg` | 状態が悪い |
| C009 | コーヒーミル | 4,000 | 手動のコーヒーミル | `images/items/9.jpg` | 良好 |
| C010 | メイクセット | 2,500 | 便利なメイクアップセット | `images/items/10.jpg` | 目立った傷や汚れなし |

**注意**: 商品画像は既に`src/storage/app/public/images/items/`ディレクトリに配置されています。画像ファイル名は`1.jpg`から`10.jpg`です。
